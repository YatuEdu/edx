...
var UserFormatterText = function (_UserQuestionBase) {
	...
	_createClass(UserFormatterText, [{
		...
		get: function get() {
			...
			var htmlStr = q_template_integer.replace(new RegExp(replacementForId, 'g'), this.id).replace(replacementForLabel, this.textLabel);
			return htmlStr;
		}
