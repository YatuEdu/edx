...
const pageTemplate = `
<div class="d-flex justify-content-between mt-3 mx-4 fs-8 fm-pagination">
...
class PaginationSimple {
    ...
    constructor(pageContainer, pageSize, total, pageFunc) {
        ...
        this.#pageNo = 1;
        this.#hash = StringUtil.randomString();
    ...
    render() {
        $(this.#pageContainer).find('.fm-pagination').remove();
        // $('#fm-pagination-'+this.#hash).remove();
