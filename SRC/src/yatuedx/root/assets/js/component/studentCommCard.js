...
<div id="{msg_ctnr_id}" style="display:none" class="student-input-board-container-extend">
	<textarea id="{std_msg_ta_id}" class="student-msg-board-extend" spellcheck="true"></textarea>
	<textarea id="{tchr_msg_ta_id}" class="teacher-msg-board-extend" spellcheck="true"></textarea>
